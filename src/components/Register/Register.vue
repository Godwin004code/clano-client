<template>
    <section class="flex w-[100%]">
       ...
       <div class="w-[40%] mx-auto md:w-[100%] side-acc md:px-5">
        ...
        <div class="mt-8 mb-5">
            <label for="name" class="text-lg font-normal md:text-white">Username</label>
            <input type="text" placeholder="Enter Your Full Name" class="border-[1px] border-[#d0d0d0] rounded-lg block w-[100%] px-2 py-2 md:py-3 md:rounded-[5px]">
        </div>
        <div class="mb-5">
            <label for="email" class="text-lg font-normal md:text-white">Email</label>
            <input type="email" placeholder="abc@gmail.com" class="border-[1px] border-[#d0d0d0] rounded-lg block w-[100%] px-2 py-2 md:py-3 md:rounded-[5px]">
        </div>
        <div class="mb-5">
        ...
        <div class="text-center md:text-white mt-3 md:mb-5">
...
<script>
import img1 from '../../assets/side-picture.png'
export default {
    data() {
        return {
            img1
