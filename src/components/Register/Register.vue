    ...
    <section class="flex w-[100%]">
       ...
       <div class="w-[40%] mx-auto md:w-[100%] side-acc md:px-5">
        ...
        <div class="mt-8 mb-5">
            ...
            <input type="text" placeholder="Enter Your Full Name" class="border-[1px] border-[#d0d0d0] rounded-lg block w-[100%] px-2 py-2 md:py-3 md:rounded-sm">
        </div>
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input type="password" placeholder="Enter Your Password" class="border-[1px] border-[#d0d0d0] rounded-lg block w-[100%] px-2 py-2 md:py-3 ">
        </div>
        <div>
            <input type="checkbox">
